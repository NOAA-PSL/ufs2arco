...
class AWSHRRRArchiveAlaska(NOAAGribForecastData, Source):
    """
    ...
    def _build_path(
        ...
        outer = f"hrrr.{t0.year:04d}{t0.month:02d}{t0.day:02d}/alaska"
        fname = f"hrrr.t{t0.hour:02d}z.wrf{file_suffix}f{fhr:02d}.ak.grib2"
